...
function Home({
  ...
  return (
    <div className="flex flex-col mx-2 md:mx-0 md:flex-row-reverse justify-center my-2">
      ...
      <form
        className="flex flex-col items-center justify-start mt-4 md:mt-20 gap-2 md:gap-10"
      ...
      >
        ...
        <button className="bg-cyan-300 rounded-full text-3xl md:text-base py-1 px-3 text-gray-700 w-full md:w-1/3 font-semibold">
          START
        </button>
      </form>
    </div>
