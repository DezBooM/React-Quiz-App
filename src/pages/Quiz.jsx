...
function Quiz({ questions, score, setScore, name, setQuestions }) {
  ...
  return (
    !loading ? <div className="mt-2">
      ...
      <Question questions={questions} setQuestions={setQuestions} options={options} currentQuestion={currentQuestion} setCurrentQuestion={setCurrentQuestion} correct={questions[currentQuestion].correct_answer} setScore={setScore} />
    </div> : <div className="flex justify-center items-center h-1/2"><HourGlass color="#4DD0E1"/></div>
  )
}
